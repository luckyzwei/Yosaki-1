...
public class TestSumiManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestSumi");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.sumiGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.sumiGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.sumiGodScore, false);
        }
