...
public class TestMonkeyManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestMonkey");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.monkeyGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.monkeyGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.monkeyGodScore, false);
        }
