...
public class UiSuhoPassCell : MonoBehaviour
{
    ...
    private void Subscribe()
    {
        ...
        //킬카운트 변경될때
        ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalSeason3).AsObservable().Subscribe(e =>
        {
    ...
    public void OnClickAdRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage($"수호 패스권이 필요합니다.");
        }
    }
    ...
    private void GetFreeReward()
    {
        ...
        userInfoParam.Add(UserInfoTable.killCountTotalSeason3, ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalSeason3).Value);
    ...
    {
        int killCountTotalColdSeason = (int)ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalSeason3).Value;
