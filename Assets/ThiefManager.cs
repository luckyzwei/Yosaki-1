...
public class ThiefManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/Thief");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable.TableDatas[UserInfoTable.thiefScore].Value)
        {
            ServerData.userInfoTable.TableDatas[UserInfoTable.thiefScore].Value = reqValue;

            ServerData.userInfoTable.UpData(UserInfoTable.thiefScore, false);
        }
