...
public class DarkManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/Dark");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.darkScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.darkScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.darkScore, false);
        }
