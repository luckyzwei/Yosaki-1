...
public class TestChunManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestChun");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.chunGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.chunGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.chunGodScore, false);
        }
