...
public class TestHellManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestHell");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.hellGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.hellGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.hellGodScore, false);
        }
