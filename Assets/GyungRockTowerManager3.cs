...
public class GyungRockTowerManager3 : ContentsManagerBase
{
    [SerializeField]
    ...
    {
        int stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower3).Value;

        var SumisanTowerTableData = TableManager.Instance.gyungRockTowerTable3.dataArray[stageId];
    ...
    {
        stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower3).Value;

        var tableData = TableManager.Instance.gyungRockTowerTable3.dataArray[stageId];
    ...
    private void SetClear()
    {
        ...
        //�ܰ���
        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower3).Value++;

        Param floorParam = new Param();

        floorParam.Add(UserInfoTable_2.gyungRockTower3, ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower3).Value);
