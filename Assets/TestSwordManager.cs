...
public class TestSwordManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestSword");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.swordGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.swordGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.swordGodScore, false);
        }
