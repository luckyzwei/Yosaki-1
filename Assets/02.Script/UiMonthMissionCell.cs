...
public class UiMonthMissionCell : MonoBehaviour
{
    [SerializeField]
    ...
    private MonthMissionData tableData;
    ...
    public void Initialize(MonthMissionData tableData)
    {
    ...
    public void OnClickGetButton()
    {
        ...
        //로컬 갱신
        EventMissionManager.UpdateEventMissionClear((MonthMissionKey)(tableData.Id), -tableData.Rewardrequire );
        EventMissionManager.UpdateEventMissionReward((MonthMissionKey)(tableData.Id), 1);
    ...
    {
        if (ServerData.iapServerTable.TableDatas[UiMonthPassBuyButton.monthPassKey].buyCount.Value <1)
        {
        ...
        //로컬 갱신
        EventMissionManager.UpdateEventMissionClear((MonthMissionKey)(tableData.Id), -tableData.Rewardrequire );
        EventMissionManager.UpdateEventMissionAdReward((MonthMissionKey)(tableData.Id), 1);
