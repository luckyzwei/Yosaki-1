...
[System.Serializable]
public class YorinMissionServerTableData
...
public class YorinMissionServerTable
{
    public static string Indate;
    public const string tableName = "YorinMission";

    private ReactiveDictionary<string, YorinMissionServerTableData> tableDatas = new ReactiveDictionary<string, YorinMissionServerTableData>();
    public ReactiveDictionary<string, YorinMissionServerTableData> TableDatas => tableDatas;
    ...
    public void Initialize()
    {
        ...
        SendQueue.Enqueue(Backend.GameData.GetMyData, tableName, new Where(), callback =>
        {
            ...
            if (rows.Count <= 0)
            {
                ...
                //이벤트미션
                YorinMissionData[] table = TableManager.Instance.YorinMission.dataArray;
                for (int i = 0; i < table.Length; i++)
                {
                    var missionData = new YorinMissionServerTableData();
            ...
            else
            {
                ...
                //이벤트미션
                var table = TableManager.Instance.YorinMission.dataArray;
