...
public class SumiManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/Sumi");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable.TableDatas[UserInfoTable.sumiScore].Value)
        {
            ServerData.userInfoTable.TableDatas[UserInfoTable.sumiScore].Value = reqValue;

            ServerData.userInfoTable.UpData(UserInfoTable.sumiScore, false);
        }
