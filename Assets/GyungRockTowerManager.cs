...
public class GyungRockTowerManager : ContentsManagerBase
{
  [SerializeField]
    ...
    {
        //int currentScore = (int)DatabaseManager.userInfoTable.GetTableData(UserInfoTable.currentFloorIdx5).Value;
    ...
    {
        int stageId = (int)ServerData.userInfoTable.GetTableData(UserInfoTable.currentFloorIdx5).Value;

        var SumisanTowerTableData = TableManager.Instance.gyungRockTowerTable.dataArray[stageId];
    ...
    {
        stageId = (int)ServerData.userInfoTable.GetTableData(UserInfoTable.currentFloorIdx5).Value;

        var tableData = TableManager.Instance.gyungRockTowerTable.dataArray[stageId];
    ...
    private void SetClear()
    {
        ...
        //�ܰ���
        ServerData.userInfoTable.GetTableData(UserInfoTable.currentFloorIdx5).Value++;

        Param floorParam = new Param();

        floorParam.Add(UserInfoTable.currentFloorIdx5, ServerData.userInfoTable.GetTableData(UserInfoTable.currentFloorIdx5).Value);
