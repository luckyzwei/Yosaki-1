...
public class TestDoManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestDo");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.doGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.doGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.doGodScore, false);
        }
